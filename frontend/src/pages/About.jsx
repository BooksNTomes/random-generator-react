        ...
        <div className='pt-10 pb-10 h-full'>
            <div className="flex m-auto browser-size">
                <div className='w-3/4 p-2 flex flex-col gap-2'>
                    ...
                    <p className='ptag-xl'>That's because I like random number generators. To an extent, many things rely on them, 
            ...
            <div className='p-2 border-1 border-black/5 rounded-[5px] shadow-lg browser-size m-auto mt-10 mb-10'>
